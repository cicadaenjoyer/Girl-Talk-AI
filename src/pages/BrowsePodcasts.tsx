  ...
  const podcastCategories = [
    {
      ...
      episodes: ["Morning Mindfulness", "Body Positivity Journey", "Stress Relief Techniques"]
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 right-1/5 text-purple-300/30 text-3xl animate-bounce">🎙️</div>
            ...
            <div key={category.title} className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/60 relative overflow-hidden transform hover:scale-105 transition-all duration-300">
              ...
              <div className="space-y-3">
                {category.episodes.map((episode, episodeIndex) => (
                  <div key={episodeIndex} className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-4 border border-purple-200/50">
                    <div className="flex items-center justify-between">
                      <span className="text-purple-700 font-medium">{episode}</span>
                      <Button
                        onClick={() => handlePlayEpisode(category.title, episode)}
              ...
              {/* Corner decorations */}
              <div className="absolute bottom-4 left-4 text-pink-300/40 text-xl">{category.icon}</div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-6 border border-purple-200/50 mb-6">
                <p className="text-xl text-purple-700 leading-relaxed">
                  Get personalized support! Share your specific situation and we'll create a custom podcast episode just for you.
                </p>
              </div>
