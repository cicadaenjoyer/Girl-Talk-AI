        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/70 relative overflow-hidden">
          ...
          <div className="flex items-start space-x-6 relative z-10">
            ...
            <div className="flex-1">
              <h4 className="text-2xl font-bold text-gray-800 mb-3 leading-tight">{podcast.title}</h4>
              <div className="flex items-center space-x-2 mb-3">
                <div className="w-8 h-8 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full flex items-center justify-center">
                  <span className="text-white text-sm">🎤</span>
                </div>
                <p className="text-purple-700 font-semibold text-lg">Hosted by {podcast.host}</p>
              </div>
              ...
              <div className="flex items-center space-x-4 mb-6">
                <span className={`px-4 py-2 rounded-full text-sm font-semibold shadow-md bg-gradient-to-r from-pink-100 to-purple-100 text-purple-700 border border-pink-200`}>
