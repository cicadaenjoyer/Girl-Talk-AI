                ...
                <div className="text-center mb-8">
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-purple-200/50">
                        <p className="text-purple-700 italic text-lg font-medium">
                            "We've created this special episode just for you,
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-purple-700 leading-relaxed">
                                This episode was crafted specifically for your
                                situation. Every strong woman started exactly
                                where you are right now. You're already taking
                                the brave step of seeking support, and that
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-3 text-center">
                                    <p className="text-sm text-purple-600 italic">
                                        💕 This personalized script was created
                                        by AI based on your specific situation
                                    </p>
                                </div>
                            </div>
                        </div>
